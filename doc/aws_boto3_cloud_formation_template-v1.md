...
| `templatePath`                                           | string  | Yes      | v1          | Path to the CloudFormation file that will be passed to the `create_stack` API call. The file must be on the local filesystem or point to a valid S3 URL, starting with `https://s3.amazonaws.com/`. If the file is in a Git repository,first use "GitRepo" to get the files onto the local system (as an example)                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `localTemplatePath`                                      | string  | Yes      | v1          | Path to the CloudFormation file on the LOCAL system. Required to loaf the data and calculate checksums.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
spec:
  ...
  variableMappings:
    ...
    - variableName: 'SECRET_ID'
      outputKey: 'MyCredentialsId'
    resources:
