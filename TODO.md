...
| ~~`HttpBasicCredential`~~                    | [#000011](https://github.com/nicc777/py-animus-extensions/issues/11)     | Can depend on `AwsBoto3GetSecret` or `CliInputPrompt` to get username and password                                                                | Scrapped   |
